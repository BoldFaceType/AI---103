---
{
  "schema_version": 1,
  "lesson_id": "IE-06",
  "title": "Extract clean grounded document representations with Content Understanding analyzers",
  "competency_ids": [
    "IE-06",
    "IE-07",
    "IE-08"
  ...
  "lab_links": [
    "scripts/labs/planned/IE-06-content-understanding-analyzers.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/ie/IE-06.json"
  ],
...
# Extract clean grounded document representations with Content Understanding analyzers
...
Scenario focus: extract document information with multimodal OCR, layout, field extraction, clean grounded representations, and Content Understanding analyzers that generate structured or markdown outputs. The target competencies are IE-06, IE-07, IE-08.
...
A synthetic invoice-and-form bundle is processed by an offline Content Understanding analyzer fixture that emits markdown, field JSON, bounding notes, and confidence records for RAG and agent use. The learner must document search mode, OCR or analyzer evidence, enrichment output, citations, and offline fixtures before live Azure use.
...
4. Reject one unsuitable option: Reject analyzer output that lacks source references, field confidence, markdown structure, or a remediation path for extraction errors.
...
- Keyword focus for review: Content Understanding analyzers, multimodal OCR, layout, field extraction, markdown output.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/ie/IE-06.json"
}
```
