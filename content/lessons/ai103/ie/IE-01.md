---
{
  "schema_version": 1,
  "lesson_id": "IE-01",
  "title": "Ingest multimodal documents, images, audio, and video",
  "competency_ids": [
    "IE-01"
  ],
  ...
  "lab_links": [
    "scripts/labs/planned/IE-01-multimodal-ingestion.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/ie/IE-01.json"
  ],
...
# Ingest multimodal documents, images, audio, and video
...
Scenario focus: ingest and index documents, images, audio, and video for retrieval and grounding. The target competencies are IE-01.
...
A compliance archive ingests PDFs, scanned forms, product images, meeting audio transcripts, and video segment metadata into an offline fixture before any live Azure ingestion pipeline is called. The learner must document search mode, OCR or analyzer evidence, enrichment output, citations, and offline fixtures before live Azure use.
...
4. Reject one unsuitable option: Reject a text-only ingestion plan when the source set includes images, audio, video, and scanned documents.
...
- Keyword focus for review: multimodal ingestion, documents, images, audio, video.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/ie/IE-01.json"
}
```
