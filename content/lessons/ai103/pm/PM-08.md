---
{
  "schema_version": 1,
  "lesson_id": "PM-08",
  "title": "Govern responsible AI filters evaluators provenance and tools",
  "competency_ids": [
    "PM-13",
    "PM-14",
    "PM-15",
  ...
  "lab_links": [
    "scripts/labs/planned/PM-08-governance.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/pm/PM-08.json"
  ],
...
# Govern responsible AI filters evaluators provenance and tools
...
Scenario focus: Plan responsible AI filters, evaluators, provenance, approvals, and tool-access controls for agents. This lesson specifically practices governance. The learner must include blocking an autonomous tool action until approval and provenance evidence exist. The target competencies are PM-13, PM-14, PM-15, PM-16.
...
A product team asks for an Azure AI capability to support the scenario: Plan responsible AI filters, evaluators, provenance, approvals, and tool-access controls for agents. The learner must choose the service or governance pattern, name the evidence artifact, and document why the rejected option fails the workload constraints.
...
4. Reject one unsuitable option: blocking an autonomous tool action until approval and provenance evidence exist.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/pm/PM-08.json"
}
```
