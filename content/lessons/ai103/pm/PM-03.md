---
{
  "schema_version": 1,
  "lesson_id": "PM-03",
  "title": "Plan Foundry infrastructure and deployment options",
  "competency_ids": [
    "PM-05",
    "PM-06"
  ],
  ...
  "lab_links": [
    "scripts/labs/planned/PM-03-infrastructure-planning.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/pm/PM-03.json"
  ],
...
# Plan Foundry infrastructure and deployment options
...
Scenario focus: Design the minimal Azure resource shape, deployment region, SKU posture, and offline preflight evidence before any provisioning. This lesson specifically practices infrastructure-planning. The learner must include planning infrastructure without creating live Azure resources. The target competencies are PM-05, PM-06.
...
A product team asks for an Azure AI capability to support the scenario: Design the minimal Azure resource shape, deployment region, SKU posture, and offline preflight evidence before any provisioning. The learner must choose the service or governance pattern, name the evidence artifact, and document why the rejected option fails the workload constraints.
...
4. Reject one unsuitable option: planning infrastructure without creating live Azure resources.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/pm/PM-03.json"
}
```
