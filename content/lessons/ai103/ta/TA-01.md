---
{
  "schema_version": 1,
  "lesson_id": "TA-01",
  "title": "Extract entities, topics, summaries, and structured JSON",
  "competency_ids": [
    "TA-01"
  ],
  ...
  "lab_links": [
    "scripts/labs/planned/TA-01-text-structured-output.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/ta/TA-01.json"
  ],
...
Scenario focus: extract entities, topics, summaries, and structured JSON with prompting and dedicated Foundry Tools. The target competencies are TA-01.
...
A care-coordination dashboard uses synthetic medical notes labeled as synthetic to extract appointment topics, medication names, and JSON follow-up tasks without using real patient data. The learner must document that examples are synthetic, choose between Foundry models and dedicated Foundry Tools, and record validation before live Azure use.
...
4. Reject one unsuitable option: Reject free-form summaries when downstream code requires structured JSON and schema validation.
...
- Keyword focus for review: entities, topics, summaries, structured JSON, Foundry Tools.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/ta/TA-01.json"
}
```
