---
{
  "schema_version": 1,
  "lesson_id": "TA-03",
  "title": "Translate text and speech with models or Translator tools",
  "competency_ids": [
    "TA-03",
    "TA-08"
  ],
  ...
  "lab_links": [
    "scripts/labs/planned/TA-03-translation.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/ta/TA-03.json"
  ],
...
# Translate text and speech with models or Translator tools
...
Scenario focus: translate text and speech using Azure Translator in Foundry Tools or model-powered translation flows. The target competencies are TA-03, TA-08.
...
A public-service agent translates a synthetic medical discharge reminder into Spanish and produces a speech-translation fixture with consent, accessibility captions, and reviewer notes. The learner must document that examples are synthetic, choose between Foundry models and dedicated Foundry Tools, and record validation before live Azure use.
...
4. Reject one unsuitable option: Reject translation without domain review when clinical meaning, accessibility captions, or consent notices are required.
...
- Keyword focus for review: translation, Azure Translator, speech translation, accessibility, consent.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/ta/TA-03.json"
}
```
