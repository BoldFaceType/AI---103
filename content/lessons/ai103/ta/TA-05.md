---
{
  "schema_version": 1,
  "lesson_id": "TA-05",
  "title": "Convert speech to text and text to speech accessibly",
  "competency_ids": [
    "TA-05"
  ],
  ...
  "lab_links": [
    "scripts/labs/planned/TA-05-speech-io.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/ta/TA-05.json"
  ],
...
# Convert speech to text and text to speech accessibly
...
Scenario focus: convert speech to text and text to speech for agentic interactions with accessibility and consent controls. The target competencies are TA-05.
...
A voice assistant uses a scripted synthetic call fixture, stores consent status, creates captions from speech-to-text, and generates text-to-speech only after policy checks pass. The learner must document that examples are synthetic, choose between Foundry models and dedicated Foundry Tools, and record validation before live Azure use.
...
4. Reject one unsuitable option: Reject recording or synthesizing user speech without consent, transcript handling rules, and accessibility alternatives.
...
- Keyword focus for review: speech to text, text to speech, accessibility, consent, captions.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/ta/TA-05.json"
}
```
