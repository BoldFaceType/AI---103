---
{
  "schema_version": 1,
  "lesson_id": "CV-04",
  "title": "Produce accessible alt text and extended descriptions",
  "competency_ids": [
    "CV-09"
  ],
  ...
  "lab_links": [
    "scripts/labs/planned/CV-04-accessibility.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/cv/CV-04.json"
  ],
...
# Produce accessible alt text and extended descriptions
...
Scenario focus: generate accessible alt text and extended descriptions that fit the user task without overclaiming visual evidence. The target competencies are CV-09.
...
A learning portal generates short alt text for thumbnails and longer descriptions for diagrams, then checks quality against a human-readable accessibility rubric. The learner must document image rights, provenance, current availability, required alt text, policy checks, and an offline fixture before live Azure use.
...
4. Reject one unsuitable option: Reject decorative or generic alt text when the image communicates task-relevant information.
...
- Keyword focus for review: accessible alt text, extended description, dual coding, quality rubric, screen reader.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/cv/CV-04.json"
}
```
