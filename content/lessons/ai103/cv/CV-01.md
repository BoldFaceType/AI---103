---
{
  "schema_version": 1,
  "lesson_id": "CV-01",
  "title": "Generate images and videos from prompts and references",
  "competency_ids": [
    "CV-01",
    "CV-02"
  ],
  ...
  "lab_links": [
    "scripts/labs/planned/CV-01-generation.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/cv/CV-01.json"
  ],
...
# Generate images and videos from prompts and references
...
Scenario focus: generate images and videos from text prompts and reference media. The target competencies are CV-01, CV-02.
...
A marketing team uses Azure AI Foundry image and video generation to create campaign drafts from an approved product brief and licensed reference media. The learner must document image rights, provenance, current availability, required alt text, policy checks, and an offline fixture before live Azure use.
...
4. Reject one unsuitable option: Reject unlicensed reference images because image rights and provenance cannot be established.
...
- Keyword focus for review: image generation, video generation, reference media, image rights, provenance.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/cv/CV-01.json"
}
```
