---
{
  "schema_version": 1,
  "lesson_id": "GA-10",
  "title": "Tune prompting, reflection evaluations, and model orchestration",
  "competency_ids": [
    "GA-13",
    "GA-14",
    "GA-16"
  ...
  "lab_links": [
    "scripts/labs/planned/GA-10-optimization.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/ga/GA-10.json"
  ],
...
# Tune prompting, reflection evaluations, and model orchestration
...
Scenario focus: Tune generation through prompting and parameters, implement reflection-style evaluations, and orchestrate multiple models, flows, and rules without exposing hidden chain-of-thought. The target competencies are GA-13, GA-14, GA-16.
...
A routing layer sends simple extraction to a small model, complex drafting to a larger model, uses rules for schema checks, and records a self-critique score that does not reveal private reasoning traces. The learner must identify the Azure component, validation gate, telemetry record, and remediation path before any live resource is used.
...
4. Reject one unsuitable option: Reject asking for hidden chain-of-thought as an evaluation artifact; use concise rationales, rubric scores, traces, and externally checkable evidence instead.
...
- Keyword focus for review: prompting, parameters, reflection evaluation, hidden chain-of-thought, multi-model, rules.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/ga/GA-10.json"
}
```
