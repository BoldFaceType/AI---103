---
{
  "schema_version": 1,
  "lesson_id": "GA-04",
  "title": "Evaluate generative applications",
  "competency_ids": [
    "GA-04"
  ],
  ...
  "lab_links": [
    "scripts/labs/planned/GA-04-evaluations.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/ga/GA-04.json"
  ],
...
# Evaluate generative applications
...
Scenario focus: Evaluate generative applications for fabrication, relevance, quality, safety, latency, and cost using measurable criteria instead of subjective preference. The target competencies are GA-04.
...
A release gate samples support answers, checks groundedness against retrieved passages, measures relevance, records latency and token cost, and blocks deployment when safety or quality thresholds fail. The learner must identify the Azure component, validation gate, telemetry record, and remediation path before any live resource is used.
...
4. Reject one unsuitable option: Reject using model confidence language as the grade because generated certainty is not deterministic evidence.
...
- Keyword focus for review: quality, relevance, safety, latency, cost, fabrication.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/ga/GA-04.json"
}
```
