---
{
  "schema_version": 1,
  "lesson_id": "GA-08",
  "title": "Orchestrate multi-agent and semiautonomous workflows",
  "competency_ids": [
    "GA-10",
    "GA-11"
  ],
  ...
  "lab_links": [
    "scripts/labs/planned/GA-08-multi-agent.py"
  ],
  "assessment_links": [
    "content/assessments/ai103/ga/GA-08.json"
  ],
...
# Orchestrate multi-agent and semiautonomous workflows
...
Scenario focus: Implement orchestrated multi-agent solutions and semiautonomous workflows with safeguards, explicit handoffs, and human approval for risky actions. The target competencies are GA-10, GA-11.
...
A triage agent summarizes a request, a specialist agent drafts a remediation plan, and a supervisor gate requires human approval before a ticket is updated or a customer is notified. The learner must identify the Azure component, validation gate, telemetry record, and remediation path before any live resource is used.
...
4. Reject one unsuitable option: Reject autonomous execution for high-impact actions because approval-flow evidence is required before side effects occur.
...
- Keyword focus for review: multi-agent, semiautonomous, human approval, safeguards, handoff.
...
```json
{
  ...
  "rubric_path": "content/assessments/ai103/ga/GA-08.json"
}
```
